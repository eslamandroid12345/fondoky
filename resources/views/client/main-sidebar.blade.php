...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="side-item side-item-category">الصفحه الرئيسيه</li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/') }}"><svg
                    ...
                    </svg><span class="side-menu__label">الرئيسيه</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">


                    <li><a class="slide-item" href="{{url('/')}}">الموقع الرسمي</a></li>
