        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form class="form" action="{{route('tourism-places.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
...
{{--                            </div>--}}
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="searchMapInput"  type="text"  class="form-control" placeholder="" name="location_ar" value="{{old('location_ar')}}">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input  id="searchMapInput2" type="text"  class="form-control" placeholder="" name="location_en" value="{{old('location_en')}}">
