...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            <li class="side-item side-item-category"> {{ trans('admin.welcome') }} {{ auth()->user()->name}}</li>
            <li class="slide">
                <a class="side-menu__item" href="{{route('home')}}"><svg
                    ...
                    </svg><span class="side-menu__label">{{__('site.list')}}</span></a>
            </li>



            <li class="side-item side-item-category">{{__('sidebar_admin.home')}}</li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/') }}"><svg
                    ...
                    </svg><span class="side-menu__label">{{__('sidebar_admin.home')}}</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">


                    <li><a class="slide-item" href="{{url('/')}}">{{__('users.website')}}</a></li>
