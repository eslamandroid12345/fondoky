...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{__('admin_create.main_sections')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة
                    {{__('admin_create.room')}}</span>
            </div>
        </div>
                    ...
                    <div class="table-responsive">
                        <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'style="text-align: center">
                            ...
                            <tr>
                                ...
                                <th>{{__('room_add.hotel_belong')}}</th>
                            </tr>
                            </thead>
                            ...
                            @foreach($rooms as $room)
                                ...
                                <tr>
                                    ...
                                    <td>{{lang() == 'ar' ? $room->hotel->name_ar : $room->hotel->name_en}}</td>
