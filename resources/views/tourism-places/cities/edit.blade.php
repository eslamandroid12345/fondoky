        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form class="form" action="{{route('tourism-places.city-update',$city->id)}}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="country_id">
                                        ...
                                        @foreach($countries as $country)
                                            ...
                                            <option value="{{$country->id}}" {{$city->country->name == $country->name ? 'selected' : ''}}>{{$country->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>{{trans('tourism_place.city_places_create')}}</label>
