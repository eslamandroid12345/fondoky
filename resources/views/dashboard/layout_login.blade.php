...
<head>
    ...
    <!-- END Custom CSS-->
       ...
       @else
        ...
        <link rel="stylesheet" type="text/css" href="{{asset('css/admin/css/pages/login-register.css')}}">
        <!-- END Page Level CSS-->
        <!-- BEGIN Custom CSS-->
...
<script src="{{asset('css/admin/vendors/js/forms/validation/jqBootstrapValidation.js')}}"
...
<!-- END MODERN JS-->
<!-- BEGIN PAGE LEVEL JS-->
<script src="{{asset('css/admin/js/scripts/forms/form-login-register.js')}}" type="text/javascript"></script>
<!-- END PAGE LEVEL JS-->
