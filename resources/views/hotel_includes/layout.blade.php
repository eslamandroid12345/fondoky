...
<head>
    ...
    {{-- start dashboard style with different languages--}}
    ...
    @else
        ...
        <link rel="stylesheet" type="text/css" href="{{asset('css/admin/css/plugins/animate/animate.css')}}">
        <link rel="stylesheet" type="text/css" href="{{asset('css/admin/css/vendors.css')}}">
        <link rel="stylesheet" type="text/css" href="{{asset('css/admin/css/core/menu/menu-types/vertical-menu.css')}}">
        <link rel="stylesheet" type="text/css" href="{{asset('css/admin/css/pages/chat-application.css')}}">
        <link rel="stylesheet" type="text/css" href="{{asset('css/admin/css/app.css')}}">
        <link rel="stylesheet" type="text/css" href="{{asset('css/admin/css/custom-rtl.css')}}">
        <link rel="stylesheet" type="text/css" href="{{asset('css/admin/css/core/menu/menu-types/vertical-menu.css')}}">
        <link rel="stylesheet" type="text/css" href="{{asset('css/admin/css/core/colors/palette-gradient.css')}}">
        <link rel="stylesheet" type="text/css" href="{{asset('css/admin/css/core/colors/palette-gradient.css')}}">
        <link rel="stylesheet" type="text/css" href="{{asset('css/admin/css/pages/timeline.css')}}">
        <link rel="stylesheet" type="text/css" href="{{asset('css/admin/css/style-rtl.css')}}">


    @endif
    {{-- end dashboard style with different languages--}}
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('css/admin/vendors/css/charts/chartist-plugin-tooltip.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('css/admin/vendors/css/forms/toggle/bootstrap-switch.min.css')}}">
    ...
    <style>
        ...
        .pagination .paginate_button,.dataTables_length,.dataTables_filter {
...
<!-- fixed-top-->
@include('hotel_includes.header')
<!-- ////////////////////////////////////////////////////////////////////////////-->
@include('hotel_includes.sidebar')

@yield('content')
<!-- ////////////////////////////////////////////////////////////////////////////-->
@include('hotel_includes.footer')
