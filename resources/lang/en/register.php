...
return [
    ...
    'name_ar' => "HotelRepositoryRepository name with arabic language",
    'name_en' => "HotelRepositoryRepository name by english language",
    ...
    'type_partake'=> "chose type of partake",
    "button" => "register data of hotel",
    "update" => "HotelRepositoryRepository update data",
    "update_hotel" => "update",
    "manger" => "HotelRepositoryRepository manger name",
    "images" => "HotelRepositoryRepository photos",
