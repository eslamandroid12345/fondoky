            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                {{-- start notifications --}}
                    <div class="dropdown nav-item main-header-notification">
                        <a class="nav-link nav-link-label" href="#" data-toggle="dropdown">
                            ...
                            <span style="position: absolute;width: 20px;height: 20px" class="badge badge-pill badge-default badge-danger badge-default badge-up badge-glow   notif-count" data-count="0">0</span>
                        </a>
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href=""><img alt=""
                                                                src="{{  URL::to('/admins/' . admin()->image) }}"></a>
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                <div class="main-img-user"><img alt="" src="{{  URL::to('/admins/' . admin()->image) }}"
                                                                class=""></div>
                                <div class="mr-3 my-auto">
                                    <h6>{{ admin()->name }}</h6><span>{{ admin()->email }}</span>
                                </div>
                            </div>
                        </div>
