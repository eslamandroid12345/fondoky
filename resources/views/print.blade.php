                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive mg-t-40">
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                ...
                                <tr>
                                    <td>1</td>
                                    <td class="tx-12">dsaghfd</td>
                                    <td class="tx-center">26,000</td>
                                    <td class="tx-right">7000</td>
