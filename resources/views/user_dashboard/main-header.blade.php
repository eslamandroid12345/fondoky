...
<nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    ...
    <div class="text-left navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="{{ url('/')  }}"><img src="{{ URL::asset('assets_2/images/logo-dark.png') }}" alt=""></a>
        <a class="navbar-brand brand-logo-mini" href="{{ url('/')  }}"><img src="{{ URL::asset('assets_2/images/logo-icon-dark.png') }}"
                alt=""></a>
