...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            <li class="side-item side-item-category"> اهلا بك {{lang() == 'ar' ? hotel()->name_ar : hotel()->name_en}}</li>
            <li class="slide">
                <a class="side-menu__item" href="{{route('hotels.reservations')}}"><svg
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{route('hotels.month.invoices')}}">الفاتوره الشهريه</a></li>
