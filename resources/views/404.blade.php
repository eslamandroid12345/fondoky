...
@section('content')
		...
		<div class="main-error-wrapper  page page-h ">
			...
			<h6>You may have mistyped the address or the page may have moved.</h6><a class="btn btn-outline-danger" href="{{ route('hotels.reservations') }}">Back to Home</a>
		</div>
		<!-- /Main-error-wrapper -->
@endsection
@section('js')
